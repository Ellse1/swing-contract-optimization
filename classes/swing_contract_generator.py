class SwingContractGenerator:
    ...
    def __init__(self, offer_price_dollar, delivery_location, powermin_mw, powermax_mw, ramping_max_mw_up_per_k, ramping_max_mw_down_per_k, price_per_mw_h_dollar):
        self.offer_price_dollar = offer_price_dollar
        ...
        self.price_per_mw_h_dollar = price_per_mw_h_dollar
